...
function SymTable(allStates) {
    ...
    this.invHashTable = hashInfo.invMap;
...
SymTable.prototype.stateForPerfectHash = function(hash) {
    return this.invHashTable[hash];
}
...
function perfectHashTable(mapping) {
    ...
    return {'count': index, 'map': aMap, 'invMap': invMap};
}
